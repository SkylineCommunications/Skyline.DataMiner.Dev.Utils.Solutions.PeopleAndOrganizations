namespace Skyline.DataMiner.Solutions.PeopleAndOrganizations.API
{
	...
	internal abstract class ObjectValidatorBase<TId>
	{
		...
		internal void PassTraceData(ObjectValidatorBase<TId> internalValidator)
		{
	...
	internal abstract class ObjectValidator<T, TId> : ObjectValidatorBase<TId>
	{
		...
		internal void PassTraceData(ObjectValidator<T, TId> internalValidator)
		{
