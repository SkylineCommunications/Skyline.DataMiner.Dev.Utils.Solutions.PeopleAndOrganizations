namespace Skyline.DataMiner.Solutions.PeopleAndOrganizations.API
{
	...
	internal class CategoriesRepository : Repository, ICategoriesRepository
	{
		...
		public IEnumerable<Category> Read(FilterElement<Category> filter)
		{
			...
			var categories = Api.DomHelpers.SlcPeopleOrganizationHelper.GetCategories(filterTranslator.Translate(filter));
		...
		{
			return ReadPaged(new TRUEFilterElement<Category>(), PeopleAndOrganizationsApi.DefaultPageSize);
		}
